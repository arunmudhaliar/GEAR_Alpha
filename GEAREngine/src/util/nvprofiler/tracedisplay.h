...
static int gTraceDisplay_DisplayW=1;
static int gTraceDisplay_DisplayH=1;
/**************************************************/
/// CTraceDisplay: 
/**
 ...
 **/
/**************************************************/
class __declspec( dllexport ) CTraceDisplay {
public:
...
#else
class __declspec( dllexport ) COGLTraceDisplay : public CTraceDisplay {
public:
