...
void gxOnlyDiffuse::bind()
{
}

void gxOnlyDiffuse::getUniformVars()
{
}

void gxOnlyDiffuse::updateShaderVars(float dt)
{
}

void gxOnlyDiffuse::inputShaderUniformVars(void* ptr)
{
}

void gxOnlyDiffuse::inputShaderAttribVars(void* ptr)
{
}

void gxOnlyDiffuse::renderAsNormalMesh(object3d* obj, const matrix4x4f* parentTM)
{
...
#if 0
void gxOnlyDiffuse::renderAsVBOMesh(objectBase* obj, const matrix4x4f* parentTM)
{
    gxMesh* mesh = (gxMesh*)obj;
...
void gxOnlyDiffuse::renderThroughHWShader(object3d* obj, const matrix4x4f* parentTM)
{
