...
gxOnlyDiffuseWithColor::gxOnlyDiffuseWithColor():
gxHWShader()
{
...
void gxOnlyDiffuseWithColor::bind()
{
}

void gxOnlyDiffuseWithColor::getUniformVars()
{
}

void gxOnlyDiffuseWithColor::updateShaderVars(float dt)
{
}

void gxOnlyDiffuseWithColor::inputShaderUniformVars(void* ptr)
{
}

void gxOnlyDiffuseWithColor::inputShaderAttribVars(void* ptr)
{
}

void gxOnlyDiffuseWithColor::renderAsNormalMesh(object3d* obj, const matrix4x4f* parentTM)
{
...
#if 0
void gxOnlyDiffuseWithColor::renderAsVBOMesh(objectBase* obj, const matrix4x4f* parentTM)
{
    gxMesh* mesh = (gxMesh*)obj;
...
void gxOnlyDiffuseWithColor::renderThroughHWShader(object3d* obj, const matrix4x4f* parentTM)
{
