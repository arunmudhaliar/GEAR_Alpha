...
float gxFont::calculateStringWidthInPixelTillNewLine(const char* str, int nChar, int iCurIndex)
{
...
void gxFont::drawOnBuffer_justify(const char* str, int cx, int cy, unsigned int& nChar, short* vertexCoordBuffer, float* textureCoordBuffer, unsigned int& nLines, unsigned short* linebuffer) const
{
    nLines=0;
    int len=nChar;
    int cntr=0;
...
bool gxFont::calculateExtraSpaceOnRightSide(const char* str, int cx, int nChar, int iCurIndex, float& extraspace, int& nWords) const
{   
    nWords=0;
    float raster_pos_x=0.0f;
    float kerning=DEBUG_KERNING;
...
void gxFont::drawOnBuffer_center(const char* str, int cx, int cy, unsigned int& nChar, short* vertexCoordBuffer, float* textureCoordBuffer, unsigned int& nLines, unsigned short* linebuffer) const
{
    nLines=0;
    int len=nChar;
    int cntr=0;
...
bool gxFont::calculateExtraSpaceOnBothSide(const char* str, int cx, int nChar, int iCurIndex, float& extraspace, int& nWords) const
{
    nWords=0;
    float raster_pos_x=0.0f;
    float kerning=DEBUG_KERNING;
...
void gxFont::drawOnBuffer_left(const char* str, int cx, int cy, unsigned int& nChar, short* vertexCoordBuffer, float* textureCoordBuffer, unsigned int& nLines, unsigned short* linebuffer) const
{
    nLines=0;
    int len=nChar;
    int cntr=0;
...
bool gxFont::canNeglectNextWord(const char* str, int cx, int nChar, int iCurIndex, float raster_pos_x) const
{
    float kerning=DEBUG_KERNING;
    //float last_space_charXPos=0.0f;
